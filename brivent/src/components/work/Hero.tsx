      ...
      <Container className="relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white leading-tight tracking-tight max-w-3xl mb-6">
            ...
            <span className="text-accent">technology. We build it.</span>
          </h1>
          <p className="text-white/60 text-lg leading-relaxed max-w-2xl">
            Explore selected products, platforms, websites, and technology
            projects built by Brivent and our team.
          </p>
        </motion.div>
      </Container>
    </section>
