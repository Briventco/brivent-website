  ...
  return (
    <section className="relative bg-dark-bg pt-40 pb-24 overflow-hidden">
      ...
      <Container className="relative z-10">
        ...
        >
          <SectionLabel light>About Brivent</SectionLabel>
          <h1 className="text-4xl md:text-6xl font-bold text-white leading-tight tracking-tight max-w-3xl mb-6">
            We are building{" "}
            <span className="text-accent">more than software.</span>
          </h1>
          <p className="text-white/60 text-lg leading-relaxed max-w-2xl">
            We are building a technology company from Africa with the
            ambition to create products, businesses, and opportunities that
            can serve people far beyond where we started.
          </p>
        </motion.div>
      </Container>
    </section>
